...
export function t(key: string) {
  // Only use Persian (Farsi) language
 ...
 * @returns true if Persian/Arabic characters are detected
 */
export function isPersianText(text: string): boolean {
  // Persian/Arabic Unicode range (approximate)
 ...
 * @returns 'rtl' if Persian text is detected, otherwise 'ltr'
 */
